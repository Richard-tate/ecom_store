        ...
        <div className="content">
          <form onSubmit={(e)=>e.preventDefault()}>
                ...
                {categories.map((cat,index)=>{
                  return (
                    <button key={index} type="button"
                     ...
                     name="category" 
                     className={`${category === cat.toLowerCase()? 'active': null}`} value={cat}>
                     {cat}
                     </button>
                  )
                })}
            ...
            <div className="form-control">
                  ...
                  <div className="colors">
                      {colors.map((c, index)=>{
                        ...
                        return(
                          <button key={index} 
                          name="color" className={`${color === c ? 'color-btn active' : 'color-btn'}`} 
                          style={{background: c}} 
                          data-color={c}
                          onClick={updateFilters}>
            ...
            <div className="form-control shipping">
                  ...
                  <input type="checkbox" name="shipping" id="shipping" className="check" onChange={updateFilters} checked={shipping}/>
            </div>
          </form>
          <button type="button" id="clearFilters" className="clear-btn" onClick={clearFilters}>clear filters</button>
        </div>
      </Wrapper>
    )
}
